class testMedicinal { //Creación de la clase
    get program() {
        let program =
        // <--- HECHOS --->
        // enfermedades
      ...
      //% 3. ¿Cual es el grado de dificultad al respirar? %
       ...
       //% 13. ¿Cuan inflamado tiene las articulaciones? %
        ...
        "evaluar_pregunta2(X, Op, L, Ln) :-  Op == 1, evaluar_tuberculosis(X, Op, tuberculosis, L, L1), evaluar_anemia(X, Op, anemia,L1, L2), evaluar_vih(X, Op, vih, L2, L3), evaluar_artritis(X, Op, artritis, L3, L4), evaluar_arritmia(X, Op, arritmia, L4, Ln);"+
                                            "Op == 2, evaluar_sinusitis(X, Op, sinusitis, L, L1), evaluar_covid(X, Op, covid, L1, Ln);"+
        ...
        "evaluar_pregunta7(X, Op, L, Ln) :- Op == 1, evaluar_anemia(X, Op, anemia, L, L1), evaluar_covid(X, Op, covid, L1, L2), evaluar_tuberculosis(X, Op, tuberculosis, L2, L3), evaluar_artritis(X, Op, artritis, L3, L4), evaluar_arritmia(X, Op, arritmia, L4, L5), evaluar_vih(X, Op, vih, L5, Ln);"+
